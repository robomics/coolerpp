...
constexpr auto fmt::formatter<coolerpp::GenomicInterval>::parse(format_parse_context &ctx)
    -> decltype(ctx.begin()) {
...
inline auto fmt::formatter<coolerpp::GenomicInterval>::format(const coolerpp::GenomicInterval &gi,
